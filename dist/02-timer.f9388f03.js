...
const options = {
    ...
    onClose (selectedDates) {
        ...
        if (dateNow.getTime() < dateStart.getTime()) refs.startBtn.disabled = false;
...
const calendar = (0, _flatpickrDefault.default)(refs.input, options);
...
function onClickStartTimer() {
    ...
    (0, _notiflixDefault.default).Notify.success("Your timer has been activated ", {
        position: "center-top"
    });
    timerId = setInterval(()=>{
        const dateNow = new Date();
...
},{"flatpickr":"llQu5","notiflix":"5WWYd","flatpickr/dist/flatpickr.min.css":"eVN6V","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"llQu5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"eVN6V":[function() {},{}]},["8lKsl","1AWyZ"], "1AWyZ", "parcelRequire3ec5")
